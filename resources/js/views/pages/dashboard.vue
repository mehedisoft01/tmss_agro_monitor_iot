                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-2" style="width: 18%">
                            <div class="segment-control1">
                                ...
                                <label style="margin: 0;padding: 6px 26px;" for="type1">Warehouse</label>

                                <input type="radio" id="type2" value="2" v-model="filter.type_id" @change="onTypeChange">
                                <label style="margin: 0;padding: 6px 49px;" for="type2">Soil</label>
                            </div>
                            <div v-if="filter.type_id == 2" class="mt-2 d-flex gap-2">
                                <button class="btn flex-fill" :class="filter.farmer_type == 1 ? 'btn-success' : 'btn-success'" @click="setFarmerType(1)">🌾 Paddy</button>

                                <button class="btn flex-fill" :class="filter.farmer_type == 2 ? 'btn-primary' : 'btn-primary'" @click="setFarmerType(2)">🥬 Vegetable</button>
                            </div>
                        </div>

                        <div class="col-md-2">
                            <datepicker :value="filter.date_from" v-model="filter.date_from" class="form-control"  placeholder="From Date"/>
                        </div>

                        <div class="col-md-2">
                            <datepicker :value="filter.date_to" v-model="filter.date_to" class="form-control"  placeholder="To Date"/>
                ...
                <div class="card-body">
                    <div v-if="filter.type_id == 1" class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <label class="text-uppercase"> <i class="bx bxs-thermometer me-2 text-danger font-18"></i>Temperature (°C)</label>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <label class="text-uppercase"> <i class="bx bxs-droplet me-2 text-primary font-18"></i>Humidity (%)</label>
                                </div>
                                <div class="card-body">
                    ...
                    <div v-if="filter.type_id == 2" class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <label class="text-uppercase"> <i class="bx bxs-bolt me-2 text-warning font-18"></i>Conductivity (us/com)</label>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <label class="text-uppercase"> <i class="bx bxs-flask me-2 text-success font-18"></i>Conductivity (us/com)</label>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <label class="text-uppercase"> <i class='bx bxs-leaf me-2 text-success'></i>Fertility</label>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <label class="text-uppercase"> <i class="bx bxs-seedling me-2 text-success font-18"></i>NPK Levels</label>
                                </div>
                                <div class="card-body">
